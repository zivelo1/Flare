...
- [x] **Log sanitization** — removed all plaintext message content, device IDs, sender IDs, hex dumps, and message IDs from log output. Diagnostic logs downgraded to debug level. Timber DebugTree only planted in debug builds
